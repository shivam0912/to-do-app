pipeline {
    ...
    parameters {
        string(name: 'GIT_REPO', description: 'Git Repository URL', defaultValue: 'https://github.com/shivam0912/to-do-app.git')
        string(name: 'GIT_BRANCH', description: 'Git Branch', defaultValue: 'gh-pages')
    }
